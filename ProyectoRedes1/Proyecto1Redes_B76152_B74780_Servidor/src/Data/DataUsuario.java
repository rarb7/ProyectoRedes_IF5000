...
public class DataUsuario {
	...
	public boolean verificarUsuarioNuevo(String nombre) {
		System.out.println("Dentro de BD el nombre es " + nombre);
		System.out.println("BD getUser " + getUsuario(nombre));
		if (getUsuario(nombre).getNombreUsuario().equals("")) {
			return false;
		} else {
			return true;
		}
